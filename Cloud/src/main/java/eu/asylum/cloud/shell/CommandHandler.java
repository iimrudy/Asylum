...
import eu.asylum.cloud.command.s.ExitCommand;
import eu.asylum.cloud.command.s.HelpCommand;
import eu.asylum.cloud.command.s.HostCommand;
import eu.asylum.cloud.command.s.InfoCommand;
import eu.asylum.cloud.command.s.PingCommand;
import eu.asylum.cloud.command.s.RequestSyncCommand;
import eu.asylum.cloud.command.s.StopAllCommand;
import eu.asylum.cloud.command.s.StopCommand;
